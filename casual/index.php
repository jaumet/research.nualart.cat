...
$casual_url = "https://nualart.com/casual/index.php";
...
if (!$_GET['imgkeywords']=='') {
	...
	$url ='https://'.$_GET['lang'].'.wikipedia.org/w/index.php?title=Special%3AWhatLinksHere&target='.$query.'&namespace=0&lang='.$_GET['lang'].'&limit='.$_GET['number'];
	$urldef = '';
...
if (!$_GET['imgkeywords']=='') {
	...
	// Debug
//	$url2 = 'https://'.$_GET['lang'].'.wikipedia.org/wiki/'.$_GET['imgkeywords'];
