...
function head_html($page_title, $status) {
    ...
    <head>
      <title>Text visualization tools with AREA [2013, Jaume Nualart]</title>\n
...
function get_areadiv($area_url)  {
	...
	$output .= "<p><a href=\"".$area_url."\"><img src=\"./images/800px-Text.jpg\" style=\"padding-left:10px;padding-right:10px;float:left;width:200px;border-width:0px;\" /><span style=\"font-size:20px;\">How we draw texts: a literature review on text visualization</span></a><br />
by Jaume Nualart (<a href=\"http://nualart.cat\" target=\"_nualart\">nualart.cat</a> Canberra. Australia)</p>";
	$output .=   "<p><b>See screenshots of the represented cases in a PDF (<a href=\"http://research.nualart.cat/textvistools/files/2013-14-HowWeDrawTexts-APENDIX.pdf\">here</a>)</b></p>";
	$output .=   "</div>";
	echo $output;
}
?>
