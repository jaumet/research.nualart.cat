...
var _26=uri.lastIndexOf("http://informationr.net/");
...
var uri;
if((_2d.charAt(0)=="http://informationr.net/")||(_2d.match(/^\w+:/))){
uri=_2d;
}else{
...
var _4b=_47.replace(/\./g,"http://informationr.net/")+".js";
var _4c=this.getModuleSymbols(_47);
var _4d=((_4c[0].charAt(0)!="http://informationr.net/")&&(!_4c[0].match(/^\w+:/)));
...
_4b=_4c.join("http://informationr.net/")+".js";
if(_4d&&(_4b.charAt(0)=="http://informationr.net/")){
_4b=_4b.slice(1);
}
...
_4c.pop();
_4b=_4c.join("http://informationr.net/")+"/"+this.pkgFileName+".js";
if(_4d&&(_4b.charAt(0)=="http://informationr.net/")){
_4b=_4b.slice(1);
}
ok=this.loadPath(_4b,((!_49)?_47:null));
...
var _9f=_9e.concat("nls").join("http://informationr.net/");
...
var _a9=[_9f,loc,_9c].join("http://informationr.net/")+".js";
...
return arr.join("http://informationr.net/").replace(/\/{2,}/g,"http://informationr.net/").replace(/((https*|ftps*):)/i,"%241/index.html");
};
...
if(_36a.path.charAt(0)!="http://informationr.net/"){
var path=_36b.path.substring(0,_36b.path.lastIndexOf("http://informationr.net/")+1)+_36a.path;
var segs=path.split("http://informationr.net/");
...
_36a.path=segs.join("http://informationr.net/");
}
}
}
}
...
var _36f="%5e((%5b%5e_/indexd41d.html?#]+):)?(//([^/?#]*))?([^?#]*)(\\?([^#]*))?(#(.*))?$";
