...
if (!$dataname) {
	head_html("We draw texts", $status);
	...
	/// Default parameters FIXME must go into the DataConfig
  	$param1 = $param1_default; //"CLA_Single_Collection";
	$param2 = $param2_default; //"CLA_Single_Collection";
	}
...
////JAUME 
    ...
    ###$legend .= '<span class="legend1"><b>'.$pa1.'</b> (blocks)</span>  <img src="./images/213px-Arrowlr.svg.png" width="35px" />  <span class="legend1"><b>'.$pa2.'</b> (colors)</span><br />';#<b>'.$pa2.': </b>';
    ...
    //$form_html .= '<div id="t2a" class="my_taba">
