...
MYDEFAULT = 
  {'all': '<h3>Welcome</h3><p><ul><li><a id="case1" class="brand case" href="?t=1">Test 1</a></li>\
      <li><a id="case2" class="brand case" href="?t=2">Test 2</a></li>\
      <li><a id="case3" class="brand case" href="?t=3">Test 3</a></li></ul></p>',
  ...
  },
  {
    ...
    'indent':'<table>\
              ...
              <tr>\
                <td id="mybody">BODY TEXT</td>\
                <td><p>\
                  <span style="padding-left: 40px;"></span>an insert body formed in a polygonal shape; \
                  <br /><span  style="padding-left: 40px;"></span>a cutting face \
                  <br /><span  style="padding-left: 60px;"></span>formed by a polygonal face of the insert body ; \
                  <br /><span  style="padding-left: 40px;"></span>a corner cutting edge \
                  <br /><span  style="padding-left: 60px;"></span>which is formed in a curved shape at a corner of the cutting face ; \
                  <br /><span  style="padding-left: 40px;"></span>a major cutting edge \
                  <br /><span  style="padding-left: 60px;"></span>which is formed along a side edge of the cutting face \
                  <br /><span  style="padding-left: 80px;"></span>that is connected to a first end of the corner cutting edge ; \
                  <br /><span  style="padding-left: 40px;"></span>and a concave portion \
                  <br /><span  style="padding-left: 60px;"></span>which is formed , in another side edge of the cutting face \
                  <br /><span  style="padding-left: 80px;"></span>that is connected to a second end of the corner cutting edge, \
                  <br /><span  style="padding-left: 100px;"></span>so as to be adjacent to the second end of the corner cutting edge,\
                  <br /><span  style="padding-left: 120px;"></span>and so as to be made concave toward the inside of the cutting face from a tangent of the corner cutting edge \
                  <br /><span  style="padding-left: 60px;"></span>drawn at the second end of the comer cutting edge.\
                  </p>\
                </td>\
              </tr>\
            </table>',
